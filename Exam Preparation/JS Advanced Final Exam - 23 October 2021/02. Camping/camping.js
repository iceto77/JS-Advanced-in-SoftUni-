class SummerCamp {
    ...
    unregisterParticipant (name){
       ...
       // let index = this.listOfParticipants.find(x=>x.name == name);
    ...
    toString(){
        ...
        for (let people of this.listOfParticipants) {
            result.push(`${people.name} - ${people.condition} - ${people.power} - ${people.wins}`);
        }
        return  result.join('\n');
    }
}
...
//console.log(summerCamp.timeToPlay("WaterBalloonFights", "Petar Petarson", "Dimitur 